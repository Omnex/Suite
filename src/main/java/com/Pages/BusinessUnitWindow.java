...
public class BusinessUnitWindow extends Base {
	...
	@FindBy(id="jqg_Grid_Businessunit_3")
	WebElement CheckBox;
	...
	@FindBy(xpath="//td[contains(text(),'Unit')]//parent::td//preceding-sibling::td//input[@role='checkbox']")
	WebElement DynamicTableCheckBox;
	
	@FindBy(xpath="//td[contains(text(),'behave')]//parent::td//preceding-sibling::td//input[@role='checkbox']")
