...
public AddEntitypage AddParentEntity() throws Exception{
	...
	HighlightFailedElements.changeColor("rgb(0,200,0)", parent, driver);
	HighlightFailedElements.drawBorder(parent, driver);
	
	Thread.sleep(8000);
	JavascriptExecutor je = (JavascriptExecutor)driver;
	je.executeScript("arguments[0].click();", parent);
...
public NewEntityPage NewEntity() throws Exception{
	driver.switchTo().frame(frames);
	Thread.sleep(6000);
	Actions a1 = new Actions(driver);
	a1.contextClick(CorporateLink).build().perform();
	...
	HighlightFailedElements.changeColor("rgb(0,200,0)", NewEntity, driver);
	HighlightFailedElements.drawBorder(NewEntity, driver);

	Thread.sleep(8000);
	JavascriptExecutor je = (JavascriptExecutor)driver;
	je.executeScript("arguments[0].click();", NewEntity);
	
	Thread.sleep(4000);
	

	return new NewEntityPage();
}
