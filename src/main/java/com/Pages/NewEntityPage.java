...
public class NewEntityPage extends Base {

	public NewEntityPage() throws Exception {
		super();
	...
	@FindBy(linkText="Omnex-South")
	WebElement CreatedEntity;
...
public void Branchnumber() throws InterruptedException{
...
public void CreatedEntity() throws InterruptedException{
	
	
	HighlightFailedElements.changeColor("rgb(0,200,0)", CreatedEntity, driver);
	HighlightFailedElements.drawBorder(CreatedEntity, driver);
...
public void CreatedEntityDelete() throws InterruptedException{
	
	Actions a1 = new Actions(driver);
	a1.contextClick(CreatedEntity);
	
	
	HighlightFailedElements.changeColor("rgb(0,200,0)", Delete, driver);
	HighlightFailedElements.drawBorder(Delete, driver);
...
public void deleteConfirmation() throws InterruptedException{
	...
	HighlightFailedElements.changeColor("rgb(0,200,0)", ClickYes, driver);
	HighlightFailedElements.drawBorder(ClickYes, driver);
